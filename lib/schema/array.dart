...
// is not any special information that can be gathered from themselves directly
  return values
      .map((value) => visit(value, parent, key, schema, addEntity))
      .toList();
}

denormalize(schema, input, unvisit) {
  schema = validateSchema(schema);
  return (input != null && input is Iterable)
...
class ArraySchema extends PolymorphicSchema {
  ArraySchema(definition,
      {String schemaAttribute, dynamic schemaAttributeFunc(input, parent, key)})
